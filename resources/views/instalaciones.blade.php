                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="col" style="margin-left: auto">
                            ...
                            <a href="/instalacion_descarga"> <button type="button" class="btngestionar" style="width: 130px; height: 30px">Exportar todo</button></a>
                            <p></p>
                            <form action="/instalaciones/importar" method="post" enctype="multipart/form-data">
                                @csrf
